...
import com.kchandrakant.learning.mapper.RecordFieldSetMapper;
import com.kchandrakant.learning.model.Transaction;
import com.kchandrakant.learning.policy.CustomSkipPolicy;
import com.kchandrakant.learning.processor.CustomItemProcessor;
import com.kchandrakant.learning.processor.SkippingItemProcessor;
...
public class SpringBatchChunkConfig {
	...
	public Step skippingStep(@Qualifier("skippingItemProcessor") ItemProcessor<Transaction, Transaction> processor,
		...
		return stepBuilderFactory.get("skippingStep").<Transaction, Transaction>chunk(10)
				.reader(itemReader(invalidInputCsv)).processor(processor).writer(writer).faultTolerant().skipLimit(5)
