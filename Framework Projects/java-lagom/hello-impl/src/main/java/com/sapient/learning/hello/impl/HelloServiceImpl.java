package com.sapient.learning.hello.impl;
...
import com.sapient.learning.hello.api.GreetingMessage;
import com.sapient.learning.hello.api.HelloService;
import com.sapient.learning.hello.impl.HelloCommand.*;
...
public class HelloServiceImpl implements HelloService {
  ...
  @Override
  public Topic<com.sapient.learning.hello.api.HelloEvent> helloEvents() {
    ...
    return TopicProducer.taggedStreamWithOffset(HelloEvent.TAG.allTags(), (tag, offset) ->
      ...
      com.sapient.learning.hello.api.HelloEvent eventToPublish;
      ...
      if (eventAndOffset.first() instanceof HelloEvent.GreetingMessageChanged) {
        ...
        eventToPublish = new com.sapient.learning.hello.api.HelloEvent.GreetingMessageChanged(
