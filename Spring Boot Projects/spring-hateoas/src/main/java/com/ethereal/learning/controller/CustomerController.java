...
import com.ethereal.learning.exception.CustomerNotFoundException;
import com.ethereal.learning.exception.InvalidCustomerRequestException;
...
public class CustomerController {
	...
	public ResponseEntity<Customer> getCustomer(@PathVariable("customerId") Long customerId) {
		...
		customer.add(
				linkTo(methodOn(OrderController.class).getCustomerOrders(customer.getCustomerId())).withRel("orders"));
