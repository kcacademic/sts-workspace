package com.sapient.learning.goals;
 ...
 * adds that a new {@code exampleVersion} property to the current Maven project.
 */
	...
	private String getVersion(String command) throws MojoExecutionException {
		try {
			...
			Executors.newSingleThreadExecutor()
					.submit(() -> new BufferedReader(new InputStreamReader(process.getInputStream())).lines()
