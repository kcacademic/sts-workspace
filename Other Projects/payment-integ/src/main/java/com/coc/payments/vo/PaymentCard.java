...
public class PaymentCard {
    ...
    @ApiModelProperty(notes = "The number of the card being used.", required = true)
    @NotBlank(message = "Number of the card is mandatory.")
    private String number;
    @ApiModelProperty(notes = "The expiration year of the card being used.", required = true)
    @NotBlank(message = "Expiration Year of the card is mandatory.")
    private String expirationYear;
    @ApiModelProperty(notes = "The expiration month of the card being used.", required = true)
